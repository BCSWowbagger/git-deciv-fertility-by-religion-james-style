...
2. Install dependencies (pip install numpy, pandas, matplotlib covers most of it, I think).
3. Go get the appropriate datafiles from the Cooperative Election Survey website. Put them in the appropriate folders as indicated by the text files in the folders.
4. Set your options in the Python scripts. This isn't fancy. It doesn't handle options through a GUI. Go in, edit the file, save it.
